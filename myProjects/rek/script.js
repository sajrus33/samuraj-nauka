...
function app() {
  ...
  // ----------------------------------++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  const inputs = [txtName, txtDescribe];
  ...
  const createMarker = (describe, name) => {
    ...
    if (name && name.length <= nameLimit) {
      if (describe && describe.length <= describeLimit) {
        inputs.forEach(input => {
          input.value = null;
        });
        ...
        alert(
          "Describe have to be minimum 1 character and maximum " +
            describeLimit +
            " characters"
        );
    } else
      alert(
        "Name have to be minimum 1 character and maximum " +
          nameLimit +
          " characters"
      );
  };
